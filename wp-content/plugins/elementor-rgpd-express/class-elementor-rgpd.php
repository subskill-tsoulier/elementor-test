...
/**
 * Main Elementor Rgpd Class
 *
 * The init class that runs the Elementor Rgpd plugin.
...
final class Elementor_Rgpd {
    ...
    public function i18n() {
        load_plugin_textdomain( 'elementor-rgpd' );
    }
    /**
     * Initialize the plugin
     *
