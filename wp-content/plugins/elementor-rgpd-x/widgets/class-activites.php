 ...
 * @since 1.0.0
 */
class Activites extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Bloc activités', 'assystem' );
    }
...
//                'media_types'   => ['svg'],
//                'description'   => esc_html__( 'Fichier SVG', 'assystem' ),
//                'default'       => "",
//                'label_block'   => true,
//            ]
//        );
...
//                        'image' => "",
    ...
    protected function render() {
        ...
        $bgcolor        = (!empty($settings['backgroundColor']))?$settings['backgroundColor']:'bg-white';
