 ...
 * @since 1.0.0
 */
class BannerProjet extends Widget_Base {
    ...
    public function get_name() {
        return 'banner-projet';
    }

    public function get_title() {
        return __( 'Bloc Bannière projet', 'assystem' );
    }
    ...
    protected function render() {
        ...
        if ( !empty($image) ) {
            $image['url']   =   wp_get_attachment_image_url($image['id'], 'banner-img');
        }
