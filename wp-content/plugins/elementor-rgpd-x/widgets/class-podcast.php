...
class Podcast extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Bloc Podcast', 'assystem' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'rss',
            array(
                'label'         => __('URL du flux (podcast)', 'assystem'),
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__("URL du flux (podcast)", "assystem"),
                'label_block'   => true,
            )
        );
        $this->add_control(
            'height',
            array(
                'label'         => __('Hauteur du bloc (en px)', 'assystem'),
                'type'          => Controls_Manager::NUMBER,
                'placeholder'   => esc_html__("Hauteur du bloc (en px)", "assystem"),
                'label_block'   => true,
            )
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        $rss            = !empty($settings['rss'])?$settings['rss']:'';
