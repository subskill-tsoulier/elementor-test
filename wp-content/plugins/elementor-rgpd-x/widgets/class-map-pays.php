 ...
 * @since 1.0.0
 */
class MapPays extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Bloc map pays', 'assystem' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __( 'Latitude', 'assystem' ),
                'type'    => Controls_Manager::TEXT,
                'placeholder' => esc_html__("Latitude", "assystem"),
                'default' => "",
            )
        );
        $this->add_control(
            'longitude',
            array(
                'label'   => __( 'Longitude', 'assystem' ),
                'type'    => Controls_Manager::TEXT,
                'placeholder' => esc_html__("Longitude", "assystem"),
                'default' => "",
            )
        );
        $this->add_control(
            'zoom_level',
            array(
                'label'   => __( 'Zoom level', 'assystem' ),
                'type'    => Controls_Manager::NUMBER,
                'placeholder' => esc_html__("Zoom level", "assystem"),
                'default' => "",
            )
        );
        $this->add_control(
            'custom_map_style',
            array(
                'label'   => __( 'Custom map style', 'assystem' ),
                'type'    => Controls_Manager::TEXTAREA,
                'placeholder' => esc_html__("Custom map style", "assystem"),
                'default' => "",
            )
        );
        $this->end_controls_section();
    ...
    protected function render() {
        ...
        $args['meta_value'] =   $settings['country_id'];
