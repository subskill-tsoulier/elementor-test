...
/**
 * Main Elementor Assystem Class
 *
 * The init class that runs the Elementor Assystem plugin.
 ...
 */
final class Elementor_Assystem {
    /**
     * Plugin Version
     *
     * @since 1.0.0
    ...
    public function i18n() {
        load_plugin_textdomain( 'elementor-assystem' );
    }
    /**
     * Initialize the plugin
     *
...
// Instantiate Elementor_Assystem.
new Elementor_Assystem();